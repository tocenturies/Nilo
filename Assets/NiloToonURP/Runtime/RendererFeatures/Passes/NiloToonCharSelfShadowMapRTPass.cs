...
namespace NiloToon.NiloToonURP
{
    public class NiloToonCharSelfShadowMapRTPass : ScriptableRenderPass
    {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            if (!getShouldRender(volumeEffect, renderingData))
            {
                shadowMapSize = 1;
                shouldRender = false;
            }
        ...
        bool getShouldRender(NiloToonShadowControlVolume volumeEffect, RenderingData renderingData)
        {
            ...
            bool allowedCameraType = renderingData.cameraData.cameraType == CameraType.Game;
            allowedCameraType |= renderingData.cameraData.cameraType == CameraType.SceneView;
