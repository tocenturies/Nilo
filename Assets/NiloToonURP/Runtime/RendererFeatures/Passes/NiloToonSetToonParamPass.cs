...
namespace NiloToon.NiloToonURP
{
    public class NiloToonSetToonParamPass : ScriptableRenderPass
    {
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            isDeferredRendering = IsDeferredRendering(renderingData);
        ...
        private bool IsDeferredRendering(RenderingData renderingData)
        {
            ...
            RenderingMode actualRenderingMode = actualRenderingMode_Getter(renderer);
        ...
        private void setParam(ScriptableRenderContext context, RenderingData renderingData)
        {
            ...
            using (new ProfilingScope(cmd, m_ProfilingSampler))
            {
                ...
                */
                ...
                //////////////////////////////////////////////////////////////////////////////////////////////////  
                if (NiloToonPlanarReflectionHelper.IsPlanarReflectionCamera(renderingData.cameraData.camera))
                {
                ...
                cmd.SetGlobalFloat(_NiloToonGlobalAllowUnityCameraDepthTextureWriteOutlineExtrudedPosition_SID, needCorrectDepthTextureDepthWrite ? 0 : 1);
                ...
                //////////////////////////////////////////////////////////////////////////////////////////////////
                SetGlobalPerCharacterDataArray(cmd);

                //////////////////////////////////////////////////////////////////////////////////////////////////
                // Character Light controllers to global array
                //////////////////////////////////////////////////////////////////////////////////////////////////
                SetGlobalNiloToonCharacterLightControllerDataArray(cmd);
                
                //////////////////////////////////////////////////////////////////////////////////////////////////
                // Light Modifier to global array
                //////////////////////////////////////////////////////////////////////////////////////////////////
                SetGlobalNiloToonPerUnityVisibleLightDataArray(cmd,renderingData);
        ...
        void SetGlobalPerCharacterDataArray(CommandBuffer cmd)
        {
            ...
            cmd.SetGlobalVectorArray(_NiloToonGlobalPerCharFaceForwardDirWSArray_SID,perCharFaceForwardDirWSArray);
            cmd.SetGlobalVectorArray(_NiloToonGlobalPerCharFaceUpwardDirWSArray_SID,perCharFaceUpwardDirWSArray);
            cmd.SetGlobalVectorArray(_NiloToonGlobalPerCharBoundCenterPosWSArray_SID,perCharBoundCenterPosWSArray);
            cmd.SetGlobalVectorArray(_NiloToonGlobalPerCharHeadBonePosWSArray_SID,perCharPerspectiveRemovalCenterPosWSArray);
        }
        
        Vector4[] finalPerCharMainDirectionalLightTintColorArray;
        Vector4[] finalPerCharMainDirectionalLightAddColorArray;
        void SetGlobalNiloToonCharacterLightControllerDataArray(CommandBuffer cmd)
        {
            ...
            cmd.SetGlobalVectorArray(_NiloToonGlobalPerCharMainDirectionalLightTintColorArray_SID,finalPerCharMainDirectionalLightTintColorArray);
        ...
        void SetGlobalNiloToonPerUnityVisibleLightDataArray(CommandBuffer cmd, RenderingData renderingData)
        {
            ...
            // reset array
            int visibleLightCount = renderingData.lightData.visibleLights.Length;
            ...
            // TODO: + dirty detect? don't call if the array is the same as previous frame
            cmd.SetGlobalVectorArray(_NiloToonGlobalPerUnityLightDataArray_SID,perUnityVisibleLightNiloToonDataArray);
            cmd.SetGlobalVectorArray(_NiloToonGlobalPerUnityLightDataArray2_SID,perUnityVisibleLightNiloToonDataArray2);
        }
    }
}