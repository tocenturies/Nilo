...
Shader "Universal Render Pipeline/NiloToon/NiloToon_Character"
{
    Properties
    {
        ...
        [Sub(_DepthTextureRimLightAndShadowGroup)]_DepthTexShadowIgnoreLightDir("360 Shadow (experimental)", Range(0,1)) = 0
        ...
        [Advanced][SubToggle(_DepthTextureRimLightAndShadowGroup,_)]_DepthTexRimLight3DRimMaskEnable("Enable?", Float) = 0
        [Advanced][Sub(_DepthTextureRimLightAndShadowGroup)]_DepthTexRimLight3DRimMaskThreshold("    threshold", Range(0,1)) = 0.5
